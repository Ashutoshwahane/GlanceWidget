...
object ApodWidget: GlanceAppWidget() {
    ...
    private suspend fun getApiData(): ImageEntity {
        return RetrofitInstance.getRetrofitInstance().create(ImageApi::class.java).getApodImage("La3VCCcJScqftN0zY2JdGkfNCegzrmSc2Zt4exT4")
    }
